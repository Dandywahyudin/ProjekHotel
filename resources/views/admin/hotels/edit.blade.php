            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                <form method="POST" action="{{route('admin.hotels.update', $hotel)}}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="star_level" class="block mt-1 w-full" type="number" name="star_level"  required autofocus autocomplete="star_level" value="{{$hotel->star_level}}"/>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{Storage::url($photos->photo)}}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]">
