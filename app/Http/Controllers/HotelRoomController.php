...
class HotelRoomController extends Controller
{
     ...
     */
    public function store(StoreRoomRequest $request, Hotels $hotel)
    {   
     ...
     */
    public function edit(Hotels $hotel,HotelRoom $hotelRoom)
    {
    ...
    public function update(UpdateRoomRequest $request, HotelRoom $hotelRoom)
    {
        ...
        return redirect()->route('admin.hotels.show', $hotelRoom->hotels_id);
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(Hotels $hotel, HotelRoom $hotelRoom)
    {
        DB::transaction(function() use ($hotelRoom){
            $hotelRoom->delete();
        });
        return redirect()->route('admin.hotels.show', $hotel->id)->with('Success');
    }
}   